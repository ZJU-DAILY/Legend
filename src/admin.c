...
int nvm_admin_cq_create_our(nvm_aq_ref ref, nvm_queue_t* cq, uint16_t id, void* vaddr, uint64_t ioaddr, size_t q_size)
{
    nvm_cmd_t command;
    nvm_cpl_t completion;
    nvm_queue_t queue;
    ...
    nvm_queue_clear_our(&queue, ctrl, true, id, vaddr, ioaddr, q_size);
...
int nvm_admin_sq_create_our(nvm_aq_ref ref, nvm_queue_t* sq, const nvm_queue_t* cq, uint16_t id, void* vaddr, uint64_t ioaddr, size_t q_size)
{
    nvm_cmd_t command;
    nvm_cpl_t completion;
    nvm_queue_t queue;
    ...
    nvm_queue_clear_our(&queue, ctrl, false, id, vaddr, ioaddr, q_size);
